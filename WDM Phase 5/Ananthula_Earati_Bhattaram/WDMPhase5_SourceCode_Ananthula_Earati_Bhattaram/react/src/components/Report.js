...
class Report extends Component {
  ...
  manageorderService= (params) => {
    ...
    httpRequest.open("POST", "http://127.0.0.1:8000/api/MonthlyPerformance");
    httpRequest.send();
  ...
  getReportTotalData = () => {
    ...
    const httpRequest = new XMLHttpRequest();
    httpRequest.open("POST", "http://127.0.0.1:8000/api/ReportTotals");
    httpRequest.send();
    httpRequest.onreadystatechange = () => {
      if (httpRequest.readyState === 4 && httpRequest.status === 200) {
    ...
    xhr.open("POST", "https://vxa3922.uta.cloud/WDMProject_Phase4/server/ReportTotals.php");
    xhr.send();
