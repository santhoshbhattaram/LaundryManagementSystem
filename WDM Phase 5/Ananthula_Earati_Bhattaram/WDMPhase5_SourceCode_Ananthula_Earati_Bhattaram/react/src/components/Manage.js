...
class Manage extends Component {
  ...
  manageorderService= (params) => {
    ...
    httpRequest.open("POST", "http://127.0.0.1:8000/api/order");
    httpRequest.send();
...
manageEquipmentService= (params) => {
  ...
  const httpRequest = new XMLHttpRequest();
  httpRequest.open("POST", "http://127.0.0.1:8000/api/equipment");
  httpRequest.send();
  httpRequest.onreadystatechange = () => {
    if (httpRequest.readyState === 4 && httpRequest.status === 200) {
       updateData(JSON.parse(httpRequest.responseText));
...
manageTaskService= (params) => {
  ...
  const httpRequest = new XMLHttpRequest();
  httpRequest.open("POST", "http://127.0.0.1:8000/api/tasks");
  httpRequest.send();
  httpRequest.onreadystatechange = () => {
    if (httpRequest.readyState === 4 && httpRequest.status === 200) {
       updateData(JSON.parse(httpRequest.responseText));
...
manageEmployeesService = (params) => {
  ...
  const httpRequest = new XMLHttpRequest();
  httpRequest.open("POST", "http://127.0.0.1:8000/api/personnel");
  httpRequest.send();
  httpRequest.onreadystatechange = () => {
    if (httpRequest.readyState === 4 && httpRequest.status === 200) {
       updateData(JSON.parse(httpRequest.responseText));
  ...
  onCellClickedmanageorder(params) {
    ...
    if (
      ...
      if (action === "delete") {
        ...
        // });
        //console.log(params.node.data);
        var data1=params.node.data;     
        const api_path='http://127.0.0.1:8000/api/deleteorder';
        axios({
          method: 'post',
          url: api_path,
          headers: {
      ...
      if (action === "update") {
        ...
        const api_path='http://127.0.0.1:8000/api/editorder';
        axios({
          method: 'post',
          url: api_path,
          headers: {
          ...
          data:{"order_Id":params.node.data.order_Id,
          "AssignedTo":params.node.data.AssignedTo,
          "Customer_Id":params.node.data.Customer_Id,
          "Type": params.node.data.Type,
          "Status":params.node.data.Status,
          "Quantity":params.node.data.Quantity
                }
        })
      .then(result => {
        console.log(result.data);
  ...
  onCellClickedNEW(params) {
    ...
    if (
      ...
      if (action === "delete") {
        ...
        const api_path='http://127.0.0.1:8000/api/equipdelete';
        axios({
          method: 'post',
          url: api_path,
          headers: {
          ...
          data:{
            "Equipment_ID":params.node.data.Equipment_ID
          }
        })
      .then(result => {
        console.log(result.data);
      ...
      if (action === "update") {
        params.api.stopEditing(false);
        console.log(params.node.data);
        const api_path='http://127.0.0.1:8000/api/equipupdate';
        axios({
          method: 'post',
          url: api_path,
          headers: {
          ...
          data:{
            "Equipment_ID": params.node.data.Equipment_ID,
            "EquipmentType":params.node.data.EquipmentType,
            "EquipmentName":params.node.data.EquipmentName,
            "Status":params.node.data.Status
          }
        })
      .then(result => {
  ...
  render() {
    ...
    const api_path='http://127.0.0.1:8000/api/insertorder';
      axios({
        method: 'post',
        url: api_path,
        headers: {
  ...
  .catch(error => this.setState({
    ...
    //console.log(this.state.Totalcost);
    const api_path='http://127.0.0.1:8000/api/insertequipment';
      axios({
        method: 'post',
        url: api_path,
        headers: {
